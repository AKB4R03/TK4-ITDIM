                    ...
                    <div class="flex items-center gap-4">
                        <div class="hidden mr-4 lg:block">
                            <ul
                                ...
                                <li
                                    class="block p-1 font-sans text-sm antialiased font-normal leading-normal text-blue-gray-900">
                                    <a href="profitAndLoss.php" class="flex items-center">
            ...
            <table class="w-full text-left table-auto min-w-max">
                ...
                <tbody>
                    ...
                    <tr class="even:bg-blue-gray-50/50">
                        ...
                        <td class="p-4">
                            <a href="editStuff.php?id=<?php echo $element['id']; ?>"
                                class="block font-sans text-sm antialiased font-medium leading-normal text-blue-gray-900">Edit</a>
                        </td>
                        <td class="p-4">
                            <a href="deleteStuff.php?id=<?php echo $element['id']; ?>"
                                class="block font-sans text-sm antialiased font-medium leading-normal text-blue-gray-900">Delete</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
